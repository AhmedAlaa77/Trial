...
class Casteljau(tkinter.Canvas):
    ...
    def draw_curve(self, points, t):
        ...
        if (len(points) == 1):
            ...
            newpoints = []
            #x0 = (1-t) * points[i][0] + t * points[i+1][0]
            #y0 = (1-t) * points[i][1] + t * points[i+1][1]
            #G_CodeFile = open('BezierLines2.nc','a')
            #G_CodeFile.write("G1 X"+str(x0) + " Y" + str(y0)+ " \n")
            #G_CodeFile.close()
            for i in range(0, len(points)-1):
                ...
                G_CodeFile = open('BezierLines2.nc','a')
                G_CodeFile.write("G2 X"+str(x) + " Y" + str(y)+ " I" +str(0.3)+ " \n")
                G_CodeFile.close()    
...
if __name__ == '__main__':
    ...
    w.draw([(35.3, 20.5),(22.5, 5.1),(31.3, -0.1)])
